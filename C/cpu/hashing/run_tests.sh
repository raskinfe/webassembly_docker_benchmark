...
echo "============================="
gcc -o my_c_executable security.c -I/usr/include/openssl -L/usr/bin/openssl -lssl -lcrypto -w
...
echo "============================="
emcc security.c -o my_c_wasm.wasm -I/home/kinfe/openssl/build/include/ -L/home/kinfe/openssl/build/lib -lssl -lcrypto
